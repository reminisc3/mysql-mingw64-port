...
MACRO(GET_MYSQL_VERSION)
  ...
  IF(${ARGC})
    SET(version_file ${ARGV0})
  ELSE()
    SET(version_file VERSION)
  ENDIF()

  MYSQL_GET_CONFIG_VALUE("MYSQL_VERSION_MAJOR" MAJOR_VERSION ${version_file})
  MYSQL_GET_CONFIG_VALUE("MYSQL_VERSION_MINOR" MINOR_VERSION ${version_file})
  MYSQL_GET_CONFIG_VALUE("MYSQL_VERSION_PATCH" PATCH_VERSION ${version_file})
  MYSQL_GET_CONFIG_VALUE("MYSQL_VERSION_EXTRA" EXTRA_VERSION ${version_file})
